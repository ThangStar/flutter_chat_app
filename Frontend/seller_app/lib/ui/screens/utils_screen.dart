      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text("Chung", style: Theme.of(context).textTheme.bodyLarge?.copyWith(
          ...
          Padding(
            padding: const EdgeInsets.all(12),
            child: Text("Khác", style: Theme.of(context).textTheme.bodyLarge?.copyWith(
                color: colorScheme(context).scrim.withOpacity(0.6)
            ),),
          ),
           ListTile(
            ...
            trailing: Switch(value: MyApp.themeNotifier.value != ThemeMode.light, onChanged: (value){
              setState(() {
                isDark = value;
